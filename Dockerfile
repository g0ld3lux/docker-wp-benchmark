...
MAINTAINER G0ld3lux <g0ld3lux@gmail.com>
LABEL org.label-schema.vendor="Uriah.G" \
      org.label-schema.name="Wordpress, Nginx, HHVM stack" \
      org.label-schema.vcs-type="git" \
      org.label-schema.vcs-url="https://github.com/g0ld3lux/docker-wp-benchmark"
...
ADD fcrontab /usr/contrib/fcrontab
ADD mariadb/ /usr/contrib/mariadb/
ADD nginx/ /etc/nginx/
ADD runit-bootstrap.sh /sbin/runit-bootstrap.sh
